  ...
  namespace Builder {
    ...
    public:
      ...
      Vacation* constructPlanner()
      {
        ...
        do {
          std::cout << std::endl
            << "Enter vacation date (YYYY MM DD) where..." << std::endl;
          std::cout
          ...
          switch(promptUser("hotel? "
                            "(0=No, 1=Grand Facadion, 2=Nostalgic Momento)")) {
          case 1:
          ...
          switch( promptUser("Park tickets? "
                             "(0=No, 1=Yes)" ) ) {
          case 1:
          ...
          switch(promptUser("Dinner Reservations? "
                            "(0=No, 1=Pancake House, 2=Objectville Diner)" )) {
          case 1:
          ...
          switch(promptUser("Special Events? "
                            "(0=No, 1=Choc-O-Holic factory tour,"
                            " 2=Pizza factory tour)" )) {
          case 1:
        ...
        } while( promptUser("Would you like to plan another day? "
                            "(0=No, 1=Yes)" ) == 1 );
