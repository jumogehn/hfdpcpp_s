...
namespace HeadFirstDesignPatterns {
  namespace FlyWeight {
    namespace FowlWeight {
      ...
      // As also mentioned by GoF [pp 205] we could omit the operation getBird()
      // and let clients instantiate unshared objects directly; however, if we
      // decided to make these objects sharable later, we'll have to change
